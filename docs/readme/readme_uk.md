<p align="center">
  <img src="../../resources/bytetensor-banner-1.png" alt="ByteTensor - Спільна робота з AI-агентами" width="100%">
</p>
...
<p align="center">
  <strong>Безкоштовний додаток з відкритим кодом для спільної роботи з AI-агентами</strong><br>
  <em>Вбудований агент | Нульове налаштування | Будь-який API ключ | Мульти-агенти | Віддалений доступ | Кросплатформеність | Автоматизація 24/7</em>
</p>
...
<p align="center">
  <strong>💬 Спільнота:</strong> <a href="https://discord.gg/2QAwJn7Egx" target="_blank">Discord (English)</a> | <a href="../../resources/wx-10.png" target="_blank">微信 (中文群)</a> | <a href="https://twitter.com/ByteTensor" target="_blank">Twitter</a>
</p>
...
[🤔 Чому варто обрати ByteTensor?](#-чому-варто-обрати-bytetensor-замість-claude-cowork) ·
...
**ByteTensor — це більше, ніж просто чат-клієнт.** Це платформа для спільної роботи (Cowork), де AI-агенти працюють пліч-о-пліч із вами на вашому комп'ютері: читають файли, пишуть код, шукають в інтернеті та автоматизують завдання. Ви бачите все, що робить агент, і завжди зберігаєте контроль.

|                                    | Традиційні AI чат-клієнти | **ByteTensor (Cowork)**                                                                                              |
| :--------------------------------- | :------------------------ | :------------------------------------------------------------------------------------------------------------------- |
...
ByteTensor постачається з повноцінним рушієм AI-агентів. На відміну від інструментів, що вимагають окремого встановлення CLI-агентів, **ByteTensor працює одразу після встановлення**.
...
- **Єдиний інтерфейс** — одна платформа для всіх ваших AI-агентів
- **Паралельні сесії** — запуск кількох агентів одночасно з незалежними контекстами
...
Інші додатки дають лише вікно чату. **ByteTensor дає повноцінного агента для спільної роботи.**
...
Ті ж самі можливості — читання/запис файлів, веб-пошук, генерація зображень — незалежно від того, яка модель використовується. ByteTensor підтримує **30+ AI-платформ**.
...
- **Трирівневі навички** — вбудовані навички (поставляються з ByteTensor), власні навички (ваші особисті) та Extension-навички (від сторонніх розширень); вмикайте/вимикайте для кожної розмови з індикатором навичок
...
<details>
<summary><strong>🔍 Детальніше про асистентів та навички ▶️</strong></summary>
...
- **🧭 HUMAN 3.0 Coach** — Тренер з особистого розвитку
- **📣 Social Job Publisher** — Публікація вакансій
- **🦞 moltbook** — Соціальна мережа AI-агентів без розгортання
- **📈 Beautiful Mermaid** — Блок-схеми, діаграми послідовностей та інше
- **🔧 OpenClaw Setup** — Налаштування інтеграції з OpenClaw
- **📖 Story Roleplay** — Рольові ігри (сумісно з SillyTavern)

**Навички**: навички з трьох джерел — вбудовані (поставляються з ByteTensor), власні (ваші особисті) та Extension (через Extension SDK). Вбудовані: `pptx`, `docx`, `pdf`, `xlsx`, `mermaid` та інші.
...
- **Режим WebUI** — доступ через браузер із телефону, планшета чи іншого ПК. Підтримка LAN, крос-мереж та серверного розгортання.
- **Інтеграція з месенджерами**
  - **Telegram** — працюйте з агентом прямо в Telegram
...
- **Природна мова** — просто скажіть агенту, що робити
- **Три режими планування** — стандартний cron-вираз (із підтримкою часового поясу), фіксований інтервал (кожні N хвилин/годин) або одноразовий тригер
- **Завдання, створені AI** — агенти можуть автономно створювати заплановані завдання під час розмови
...
<details>
<summary><strong>🔍 Деталі запланованих завдань ▶️</strong></summary>

<br>

**Режими планування:**

- `Cron-вираз` — стандартний 5-польовий cron із підтримкою часового поясу (напр. `0 9 * * 1`, `Asia/Shanghai`)
- `Кожні N хвилин/годин` — фіксований інтервал, напр. запускати кожні 30 хвилин
- `Одноразовий` — один раз у вказані дату/час, потім автоматично вимкнути

**Режими виконання:**

- `Продовжити в існуючій розмові` — додає до прив'язаної розмови, AI зберігає повну історію контексту
- `Створювати нову розмову щоразу` — відкриває нову сесію при кожному тригері, ідеально для незалежних періодичних звітів
...
- **Режим без сну** — ByteTensor автоматично запобігає переходу системи у сплячий режим, поки активні завдання, та визначає пропущені тригери після пробудження
...
### **Панель попереднього перегляду — Миттєвий результат**
...
### **Розумне керування файлами — Автоматизація рутини**

_Пакетне перейменування, автоматичне впорядкування, розумна класифікація та злиття файлів._

<p align="center">
  <img src="../../resources/bytetensor sort file 2.gif" alt="Керування файлами" width="800">
</p>

---

## 🤔 Чому варто обрати ByteTensor замість Claude Cowork?

ByteTensor — це **безкоштовний Multi-AI Agent десктоп**. На відміну від Claude Cowork, який працює лише на macOS і обмежений лише Claude, ByteTensor — це версія з підтримкою всіх моделей та платформ.
...
Натисніть кнопку вище, щоб перейти на сторінку Releases та завантажити інсталятор для вашої платформи (macOS / Windows / Linux).
...
Будь ласка, прочитайте [CONTRIBUTING.md](../../CONTRIBUTING.md) перед відкриттям PR.

1. Зробіть форк цього проекту
2. Створіть гілку функції (`git checkout -b feature/AmazingFeature`)
3. Зафіксуйте зміни (`git commit -m 'Add some AmazingFeature'`)
4. Надішліть у гілку (`git push origin feature/AmazingFeature`)
...
**Якщо вам подобається проект, поставте нам зірочку ⭐**
