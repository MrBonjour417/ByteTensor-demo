# ByteTensor Development Justfile
# Usage: just <recipe>
...
preflight:
    ...
    $failed = $false
    Write-Host "=========================================="
    Write-Host "  ByteTensor Build Preflight Check"
    Write-Host "=========================================="
    Write-Host ""
...
info:
    #!/usr/bin/env bash
    echo "ByteTensor Build Environment"
    echo "========================"
...
build-win: preflight
    ...
    Get-Process -Name "ByteTensor","electron" -ErrorAction SilentlyContinue | Stop-Process -Force -ErrorAction SilentlyContinue
