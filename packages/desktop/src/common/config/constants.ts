...
/** 临时文件时间戳分隔符 */
export const BYTETENSOR_TIMESTAMP_SEPARATOR = '_bytetensor_';

/** 用于匹配和清理时间戳后缀的正则表达式 */
export const BYTETENSOR_TIMESTAMP_REGEX = /_bytetensor_\d{13}(\.\w+)?$/;
export const BYTETENSOR_FILES_MARKER = '[[AION_FILES]]';
