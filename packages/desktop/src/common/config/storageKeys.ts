...
export const STORAGE_KEYS = {
  ...
  WORKSPACE_TREE_COLLAPSE: 'bytetensor_workspace_collapse_state',

  /** Sidebar collapse state / 侧边栏折叠状态 */
  SIDEBAR_COLLAPSE: 'bytetensor_sider_collapsed',

  /** Theme preference / 主题偏好 */
  THEME: 'bytetensor_theme',

  /** Language preference / 语言偏好 */
  LANGUAGE: 'bytetensor_language',
} as const;
