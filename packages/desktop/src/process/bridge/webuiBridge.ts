 ...
 * generate-qr-token) are NOT handled here — those are HTTP routes on ByteTensorCore's
 ...
 * WebUI instance requires Electron's app.* / Node child_process — ByteTensorCore
