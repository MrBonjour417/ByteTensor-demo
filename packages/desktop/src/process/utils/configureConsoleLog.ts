 ...
 *   - macOS:   ~/Library/Logs/ByteTensor/YYYY-MM-DD.log
 *   - Windows: %USERPROFILE%\AppData\Roaming\ByteTensor\logs\YYYY-MM-DD.log
 *   - Linux:   ~/.config/ByteTensor/logs/YYYY-MM-DD.log
 *
...
const BACKEND_PREFIX = '[ByteTensorCore]';
