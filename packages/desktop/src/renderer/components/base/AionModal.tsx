...
const AionModal: React.FC<AionModalProps> = ({
  ...
  return (
    <Modal
      ...
      footer={null}
      onCancel={onCancel}
      className={`bytetensor-modal ${className}`}
      style={finalStyle}
      getPopupContainer={() => document.body}
    >
      <div className='bytetensor-modal-wrapper' style={{ borderRadius: borderRadiusVal }}>
        {renderHeader()}
        <div className='bytetensor-modal-body-content' style={bodyInlineStyle}>
          {children}
        </div>
        {renderFooter()}
      </div>
