 ...
 * <ByteTensorScrollArea direction="x" className="w-400px">
 *   <div className="whitespace-nowrap">Content...</div>
 * </ByteTensorScrollArea>
 *
 * // 双向滚动 / Both directions
 * <ByteTensorScrollArea direction="both" className="h-400px w-400px">
 *   <div>Content...</div>
 * </ByteTensorScrollArea>
 * ```
 */
interface ByteTensorScrollAreaProps extends React.HTMLAttributes<HTMLDivElement> {
...
const ByteTensorScrollArea: React.FC<ByteTensorScrollAreaProps> = ({
  children,
  className,
  direction = 'y',
...
ByteTensorScrollArea.displayName = 'ByteTensorScrollArea';

export default ByteTensorScrollArea;
