...
const UpdateModal: React.FC = () => {
  ...
  useEffect(() => {
    ...
    window.addEventListener('bytetensor-open-update-modal', handleOpenUpdateModal);

    return () => {
      removeOpenListener();
      window.removeEventListener('bytetensor-open-update-modal', handleOpenUpdateModal);
    };
  }, []);
