...
export const useConversationActions = ({
  ...
  /**
   * Remove project state — rendered via ByteTensorModal in the GroupedHistory component.
   * Uses project's design system: ByteTensorModal component with danger-styled action button.
   */
