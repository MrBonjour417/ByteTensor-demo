...
export const WORKSPACE_EXPANSION_STORAGE_KEY = 'bytetensor_workspace_expansion';
export const WORKSPACE_EXPANSION_EVENT = 'bytetensor:workspace-expansion-changed';
