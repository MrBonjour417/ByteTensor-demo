export const WORKSPACE_TOGGLE_EVENT = 'bytetensor-workspace-toggle';
export const WORKSPACE_STATE_EVENT = 'bytetensor-workspace-state';
export const WORKSPACE_HAS_FILES_EVENT = 'bytetensor-workspace-has-files';
