...
function getLogFilePath(): string {
  ...
  // Dev mode uses "ByteTensor-Dev", production uses "ByteTensor"
  const devPath = path.join(os.homedir(), 'Library', 'Logs', 'ByteTensor-Dev', `${today}.log`);
  const prodPath = path.join(os.homedir(), 'Library', 'Logs', 'ByteTensor', `${today}.log`);
