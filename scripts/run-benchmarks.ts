...
function printTerminalReport(report: BenchReport): void {
  console.log('\n  ╔══════════════════════════════════════════════════════════════╗');
  console.log('  ║              ByteTensor Performance Benchmark Report            ║');
  console.log('  ╚══════════════════════════════════════════════════════════════╝');
...
<head>
<meta charset="utf-8">
<title>ByteTensor Benchmark Report - ${report.timestamp}</title>
<style>
...
<body>
<h1>ByteTensor Performance Benchmark Report</h1>
<div class="meta">
