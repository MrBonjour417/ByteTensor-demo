...
for f in ByteTensor-1.0.0-win-x64.exe ByteTensor-1.0.0-win-arm64.exe ByteTensor-1.0.0-mac-x64.dmg ByteTensor-1.0.0-mac-arm64.dmg ByteTensor-1.0.0.deb ByteTensor-1.0.0-arm64.deb; do
  if [ ! -f "$OUTPUT_DIR/$f" ]; then
