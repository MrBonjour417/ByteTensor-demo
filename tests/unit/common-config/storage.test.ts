...
describe('storage runtime exports', () => {
  ...
  describe('EnvStorage', () => {
    ...
    it('set/get roundtrip with bytetensor.dir object', async () => {
      const dirs = {
        workDir: '/a',
        cacheDir: '/b',
        dataDir: '/c',
      ...
      await EnvStorage.set('bytetensor.dir', dirs);
      const result = await EnvStorage.get('bytetensor.dir');
  ...
  describe('storage isolation', () => {
    it('ConfigStorage and EnvStorage do not share state', async () => {
      ...
      await EnvStorage.set('bytetensor.dir', {
        workDir: '/x',
        cacheDir: '/y',
        dataDir: '/z',
        homeDir: '/h',
      ...
      const envDir = await EnvStorage.get('bytetensor.dir');
